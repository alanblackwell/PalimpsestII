    ...
    buttons: [
      {
        ...
        factory: () => new EllipseLayer(
          Node.canvasWidth  * (0.35 + Math.random() * 0.30),
          Node.canvasHeight * (0.30 + Math.random() * 0.40),
          Node.canvasWidth  * (0.15 + Math.random() * 0.20),
          Node.canvasHeight * (0.12 + Math.random() * 0.18),
          rndColour(),
        ),
      },
      {
